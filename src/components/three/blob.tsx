...
const Blob: React.FC<BlobProps> = ({ handPoints }) => {
...
const HandBlob: React.FC<HandBlobProps> = ({ results }) => {
  ...
  return <Blob handPoints={handPoints} />;
};
